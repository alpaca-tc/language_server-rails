...
RSpec.describe LanguageServerRails::ContentContext do
  context 'InstanceMethods' do
    ...
    describe '#cursor_text' do
      ...
      shared_examples_for 'a cursor text' do |line:, character:, text:|
        let(:line) { line }
      ...
      context 'feed_manager.rb' do
        ...
        # TODO
        # it_behaves_like 'a cursor text', line: 77, character: 61, text: 'FeedManager::MAX_ITEMS'
      end
      ...
      context 'custom_template.rb' do
        ...
        # it_behaves_like 'a cursor text', line: 7, character: 0, text: 'hello'
        # it_behaves_like 'a cursor text', line: 10, character: 6, text: '<<-HEREDOC'
        # it_behaves_like 'a cursor text', line: 15, character: 0, text: 'hello'
    ...
    fdescribe '#cursor_context' do
      subject { instance.cursor_context }

      shared_examples_for 'a cursor context' do |line:, character:, text:|
        let(:line) { line }
        let(:character) { character }
